namespace UniGetUI.PackageEngine.Interfaces
{
    public interface IPackageDetails
    {
        ...
        /// <summary>
        /// A default hint message to display when package installation fails
        /// and no specific error pattern is matched.
        /// </summary>
        public string? InstallErrorHint { get; set; }

        /// <summary>
        /// A list of conditional error hints that match specific error patterns.
        /// When an error occurs, the system will check each rule's pattern against
        /// the command output and display the corresponding hint if matched.
        /// </summary>
        public List<ErrorHintRule> InstallErrorHints { get; }
        ...
        /// <summary>
        /// Represents a conditional error hint rule that matches a specific error pattern.
        /// </summary>
        public struct ErrorHintRule
        {
            /// <summary>
            /// The pattern to match against the command output (case-insensitive substring match).
            /// </summary>
            public string Pattern;

            /// <summary>
            /// The hint message to display when this pattern is matched.
            /// </summary>
            public string Hint;
        }
    }
