@echo off
SET unigetuipath=%~dp0..\aiDAPTIVAppStore.exe
set pwsh=C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe
echo Scoop Installer Assistant - aiDAPTIVAppStore
...
if %errorlevel% equ 0 (
    echo aiDAPTIVAppStore will be restarted to continue.
    pause
    taskkill /im wingetui.exe /f
    taskkill /im unigetui.exe /f
    taskkill /im aiDAPTIVAppStore.exe /f
