...
public partial class OperationControl: INotifyPropertyChanged
{
    ...
    {
        ShowErrorToast();
        // Automatically show the error dialog when operation fails
        _ = ShowOperationFailedDialogAsync();
    }

    private async Task ShowOperationFailedDialogAsync()
    {
        try
        {
        ...
        {
            Logger.Warn($"Failed to show operation failed dialog: {ex.Message}");
        }
    }
