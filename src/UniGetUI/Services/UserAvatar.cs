...
{
    // === GitHub 登入功能已停用 - PointButton 保留但不使用 ===
    ...
    /// <summary>
    /// UserAvatar 控制項 - GitHub 登入功能已停用，此控制項現為空白
    /// </summary>
    public partial class UserAvatar: UserControl
    {
        public UserAvatar()
        {
            // GitHub 登入功能已停用 - 不顯示任何內容
            VerticalContentAlignment = VerticalAlignment.Center;
            HorizontalContentAlignment = HorizontalAlignment.Center;
            Content = null; // 不顯示任何內容
            Visibility = Visibility.Collapsed; // 隱藏控制項
        }
        ...
        // private object GenerateLoginControl() { return null; }
        // private Task<object> GenerateLogoutControl() { return Task.FromResult<object>(null); }
    }
}

/* === 原始 UserAvatar 程式碼 (已註解) ===
using Windows.UI;
using Microsoft.UI;
using Microsoft.UI.Input;
using Microsoft.UI.Xaml;
    ...
    public partial class UserAvatar: UserControl
    {
        ...
        private async Task<PointButton> GenerateLogoutControl()
        {
            ...
            var loginButton = new PointButton
            {
                ...
                Background = new SolidColorBrush(ActualTheme is ElementTheme.Dark? Microsoft.UI.Colors.DarkRed: Microsoft.UI.Colors.PaleVioletRed),
