...
namespace UniGetUI.Services
{
    ...
    public class GitHubBackupService
    {
        ...
        public Task UploadPackageBundle(string bundleContents)
        {
            // 已停用
            throw new NotSupportedException("GitHub 備份功能已停用");
        }

        public Task<IEnumerable<string>> GetAvailableBackups()
        {
            // 已停用
            return Task.FromResult<IEnumerable<string>>(Array.Empty<string>());
        }

        public Task<string?> GetBackupContents(string backupName)
        {
            // 已停用
