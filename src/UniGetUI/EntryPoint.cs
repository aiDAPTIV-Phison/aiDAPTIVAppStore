...
namespace UniGetUI
{
    public static class EntryPoint
    {
        ...
        private static void Main(string[] args)
        {
            ...
            try
            {
                // Initialize app branding from generated constants
                InitializeBranding();
        ...
        /// <summary>
        /// Initialize CoreData with app branding values from AppBranding.props
        /// </summary>
        private static void InitializeBranding()
        {
            CoreData.AppName = AppBranding.DisplayName;
            CoreData.AppDataFolderName = AppBranding.DataFolderName;
            CoreData.AppBackupFolderName = AppBranding.BackupFolderName;
            CoreData.AppIdentifierValue = AppBranding.Identifier;
        }
    }
}
