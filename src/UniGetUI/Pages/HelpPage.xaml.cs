    ...
    public sealed partial class HelpPage : Page, IDisposable, IEnterLeaveListener
    {
        ...
        private async Task InitializeWebView()
        {
            ...
            webView.NavigationStarting += (_, e) =>
            {
                ...
                if (e.Uri.ToString().Contains("github.com") && !e.Uri.ToString().Contains("isWingetUIIframe"))
                {
                    e.Cancel = true;
        ...
        private async Task _navigateTo(string piece, bool skipWait)
        {
            ...
            webView.Source = new Uri($"{CoreData.HelpBaseUrl}/{piece}");
        }
        ...
        private void HomeButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            webView.Source = new Uri(CoreData.HelpBaseUrl);
        }
