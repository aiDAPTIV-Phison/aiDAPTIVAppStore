...
namespace UniGetUI.Interface
{
    public sealed partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            // Set branding from AppBranding constants
            Title = AppBranding.DisplayName;
            TitleBar.Title = AppBranding.DisplayName;
            UniGetUITitle.Text = AppBranding.DisplayName;
            ...
            AppWindow.SetIcon(Path.Join(CoreData.UniGetUIExecutableDirectory, "Assets", "Images", AppBranding.IconFileName));
            ...
            _ = ModelUpdater.ModelCheckLoop(this, ModelDownloadBanner);
        ...
        private void AddToSubtitle(string line)
        {
            ...
            Title = AppBranding.DisplayName + " - " + _currentSubtitle;
        ...
        public void HandleNotificationActivation(AppNotificationActivatedEventArgs args)
        {
            ...
            else if (action == NotificationArguments.SwitchModel)
            {
                ModelUpdater.PerformModelSwitch();
            }
            else
            {
        ...
        public void ProcessCommandLineParameters()
        {
            while (ParametersToProcess.Count > 0)
            {
                ...
                else if (Path.IsPathFullyQualified(param) && File.Exists(param))
                {
                    ...
                    // }
                    // else
                    if (param.EndsWith(AppBranding.ExecutableFileName) || param.EndsWith(AppBranding.DllFileName) || param.EndsWith("UniGetUI.exe") || param.EndsWith("UniGetUI.dll"))
                    {
                        /* Skip */
                    }
                    else
                ...
                else if (param.EndsWith(AppBranding.ExecutableFileName) || param.EndsWith(AppBranding.DllFileName) || param.EndsWith("UniGetUI.exe") || param.EndsWith("UniGetUI.dll"))
                {
                    /* Skip */
                }
                else
