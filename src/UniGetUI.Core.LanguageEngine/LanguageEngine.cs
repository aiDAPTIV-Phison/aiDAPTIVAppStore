...
namespace UniGetUI.Core.Language
{
    public class LanguageEngine
    {
        ...
        {
            // Use app name from CoreData (which is initialized from AppBranding)
            ...
            if (key == "WingetUI")
            {
                ...
                {
                    return appName + " (" + formerly + ")";
                }

                return appName + " (formerly WingetUI)";
            }
            ...
            {
                return value.Replace("WingetUI", appName).Replace("UniGetUI", appName).Replace("UnigetUI", appName);
            }

            return key.Replace("WingetUI", appName).Replace("UniGetUI", appName).Replace("UnigetUI", appName);
        }
