...
; Include auto-generated branding definitions from AppBranding.props
; Run scripts\generate_iss_branding.ps1 to regenerate
#include "InstallerExtras\AppBranding.iss"

#define MyAppVersion "NXWI_1.0.0-0004"
; MyAppName and MyAppExeName are defined in AppBranding.iss
...
AppModifyPath="{app}\{#MyAppName}.Installer.exe" /silent /NoDeployInstaller
...
procedure QuadKill(FileName1: String; FileName2: String; FileName3: String; FileName4: String);
var
  ResultCode: Integer;
begin
    Exec('taskkill.exe', '/f /im ' + '"' + FileName1 + '"', '', SW_HIDE,
    ...
    Exec('taskkill.exe', '/f /im ' + '"' + FileName3 + '"', '', SW_HIDE,
     ewWaitUntilTerminated, ResultCode);
    Exec('taskkill.exe', '/f /im ' + '"' + FileName4 + '"', '', SW_HIDE,
     ewWaitUntilTerminated, ResultCode);
end;
...
begin
  ...
  begin
    ...
    MsgBox('There is an invalid character in the selected install location. ' +
      ...
      'Please input a valid path to continue, such as '+ExpandConstant('{commonpf64}')+'\{#MyAppName}', mbError, MB_OK);
  end;
end;
...
[Registry]
Root: HKCU; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Run"; ValueType: string; ValueName: "{#MyAppName}"; ValueData: """{app}\{#MyAppExeName}"" --daemon"; Flags: uninsdeletevalue; Tasks: regularinstall;
Root: HKCU; Subkey: "Software\Microsoft\Windows\CurrentVersion\Explorer\StartupApproved\Run"; ValueType: binary; ValueName: "{#MyAppName}"; ValueData: "03"; Flags: uninsdeletevalue; Tasks: regularinstall; Check: CmdLineParamExists('/NoRunOnStartup');
...
Root: HKA; Subkey: "Software\Classes\.ubundle"; ValueType: string; ValueData: "{#MyAppName}.PackageBundle"; Flags: uninsdeletekey; Tasks: regularinstall;
Root: HKA; Subkey: "Software\Classes\{#MyAppName}.PackageBundle"; ValueType: string; ValueData: {cm:PackageBundleName}; Flags: uninsdeletekey; Tasks: regularinstall;
Root: HKA; Subkey: "Software\Classes\{#MyAppName}.PackageBundle\DefaultIcon"; ValueType: string; ValueData: "{app}\{#MyAppExeName},0"; Flags: uninsdeletekey; Tasks: regularinstall;
Root: HKA; Subkey: "Software\Classes\{#MyAppName}.PackageBundle\shell\open\command"; ValueType: string; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Flags: uninsdeletekey; Tasks: regularinstall;


[Files]
; Deploy installer for autorepair jobs (unless disabled)
Source: "{srcexe}"; DestDir: "{app}"; DestName: "{#MyAppName}.Installer.exe"; Flags: external ignoreversion; Tasks: regularinstall; Check: not CmdLineParamExists('/NoDeployInstaller');
; Deploy integrity tree
Source: "phison_bin\IntegrityTree.json"; DestDir: "{app}"; Flags: createallsubdirs ignoreversion recursesubdirs;
; Deploy executable files
Source: "phison_bin\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion; BeforeInstall: QuadKill('WingetUI.exe', 'UniGetUI.exe', '{#MyAppExeName}', 'choco.exe');
Source: "phison_bin\*"; DestDir: "{app}"; Flags: createallsubdirs ignoreversion recursesubdirs;
; Deploy chocolatey (unless disabled)
Source: "src\UniGetUI.PackageEngine.Managers.Chocolatey\choco-cli\*"; DestDir: "{userpf}\..\{#MyAppDataFolderName}\Chocolatey"; Flags: createallsubdirs ignoreversion recursesubdirs uninsneveruninstall; Tasks: regularinstall\chocoinstall; Check: not CmdLineParamExists('/NoChocolatey');
...
Filename: {sys}\taskkill.exe; Parameters: "/f /im {#MyAppExeName}"; Flags: skipifdoesntexist runhidden; RunOnceId: "KillAppExe"
